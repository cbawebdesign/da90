...
import { CommunicationsoneComponent } from './communicationsone.component';
...
const routes: RoutesWithContent = [
  {
    path: '',
    component: CommunicationsoneComponent,
...
@NgModule({
  declarations: [ CommunicationsoneComponent],
  imports: [
    CommonModule,
    FlexLayoutModule,
    // PdfViewerModule,
...
export class CommunicationsoneModule { }
