...
@Component({
  selector: 'wm-communicationsone',
  templateUrl: './communicationsone.component.html',
  styleUrls: ['./communicationsone.component.scss']
})
export class CommunicationsoneComponent extends DatabaseGroup<PostData> {
  ...
  constructor (db: DatabaseService, private utils: EmojiUtils,
    ...
    this.posts$ = this.pipe(
      ...
      where('categories', '==', 'Communicationsone'),
