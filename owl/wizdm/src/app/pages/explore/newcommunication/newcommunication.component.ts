...
@Component({
  selector: 'wm-newcommunication',
  templateUrl: './newcommunication.component.html',
  styleUrls: ['./newcommunication.component.scss']
})
export class NewcommunicationComponent extends DatabaseGroup<PostData> {
  ...
  constructor (db: DatabaseService, private utils: EmojiUtils,
    ...
    this.posts$ = this.pipe(
      ...
      where('categories', '==', 'NewCommunication'),
