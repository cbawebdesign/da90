...
@Component({
  selector: 'wm-cas22q2',
  templateUrl: './cas22q2.component.html',
  styleUrls: ['./cas22q2.component.scss']
})
export class cas22q2Component extends DatabaseGroup<PostData> {
