...
@Component({
  selector: 'wm-q12023',
  templateUrl: './q12023.component.html',
  styleUrls: ['./q12023.component.scss']
})
export class q12023Component extends DatabaseGroup<PostData> {
  ...
  constructor (db: DatabaseService, private utils: EmojiUtils,
    ...
    this.posts$ = this.pipe(
      ...
      where('categories', '==', 'Financials Q1-2023'),
