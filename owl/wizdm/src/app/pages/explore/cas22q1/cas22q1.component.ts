...
@Component({
  selector: 'wm-cas22q1',
  templateUrl: './cas22q1.component.html',
  styleUrls: ['./cas22q1.component.scss']
})
export class cas22q1Component extends DatabaseGroup<PostData> {
