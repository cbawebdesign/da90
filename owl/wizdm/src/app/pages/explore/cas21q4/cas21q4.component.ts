...
@Component({
  selector: 'wm-cas21q4',
  templateUrl: './cas21q4.component.html',
  styleUrls: ['./cas21q4.component.scss']
})
export class cas21q4Component extends DatabaseGroup<PostData> {
