...
@Component({
  selector: 'wm-cas22q4',
  templateUrl: './cas22q4.component.html',
  styleUrls: ['./cas22q4.component.scss']
})
export class cas22q4Component extends DatabaseGroup<PostData> {
