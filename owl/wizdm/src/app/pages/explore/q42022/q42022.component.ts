...
@Component({
  selector: 'wm-q42022',
  templateUrl: './q42022.component.html',
  styleUrls: ['./q42022.component.scss']
})
export class q42022Component extends DatabaseGroup<PostData> {
  ...
  constructor (db: DatabaseService, private utils: EmojiUtils,
    ...
    this.posts$ = this.pipe(
      ...
      where('categories', '==', 'Financials Q4-2022'),
