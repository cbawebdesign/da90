...
@Component({
  selector: 'wm-q32022',
  templateUrl: './q32022.component.html',
  styleUrls: ['./q32022.component.scss']
})
export class q32022Component extends DatabaseGroup<PostData> {
  ...
  constructor (db: DatabaseService, private utils: EmojiUtils,
    ...
    this.posts$ = this.pipe(
      ...
      where('categories', '==', 'Financials Q3-2022'),
