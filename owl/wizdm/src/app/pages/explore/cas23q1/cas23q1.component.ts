...
@Component({
  selector: 'wm-cas23q1',
  templateUrl: './cas23q1.component.html',
  styleUrls: ['./cas23q1.component.scss']
})
export class cas23q1Component extends DatabaseGroup<PostData> {
